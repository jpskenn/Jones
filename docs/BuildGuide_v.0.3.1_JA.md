...
- A6とB6、A7とB7のように緑または赤の線でつながっているピンや、GND同士、VCC同士で導通があることを確認します。  
- それ以外は導通しないことを確認します。  
...
LED取り付け方向を示す縦線とLEDの方向、LED5およびLED6への予備はんだ
...
[Jones v.0.3.1 KiCadプロジェクト](../PCB/v.0.3.1/Jones_v.0.3.1_003/)のPCB設計を参照し、パッド、ダイオード、MCUのピンなどの導通確認により調査します。  
