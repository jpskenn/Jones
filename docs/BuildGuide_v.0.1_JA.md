...
*キーボード基板としての機能には問題ありませんが、ブロッカーのネジ位置が合わず取り付けできなものがあります。*
...
これらの箇所では、基板を低頭ネジでケースへ固定し、スイッチの足がネジ穴に重なる場合は、3pinのスイッチ、または足をカットした5pinスイッチを取り付けてください。  
...
### スタビライザー  
Jonesレイアウトでは左シフトキーのサイズが2Uのため、スタビライザーを取り付けるとケース取り付けネジと干渉し、ネジ止めできなくなる場合があります。  
...
- 基板のシルク表記が少ないため、部品の設置方向がわかりづらい箇所があるため、ビルドガイドで確認してください。
- コンデンサC5とSW19のソケットが干渉するため、コンデンサを少しずらして設置し、ソケットを削ることで回避可能です。
...
キースイッチの爪がかからなくなりますが、MDFやアクリルでも作成できると思います。(未作成)
...
![USB leg](../assets/IMG_1732.jpeg)  

切り離した箇所はとがっているので、ニッパーでカットしたり、やすりで削っておきます。  

### MCU、USBコネクタ関連部品の取り付け

各部品の取り付け説明と、部品の取り付け例の写真を参考に、作業してください。
...
KBDfansのTOFUでは問題ありませんが、お安いプラスチックケースの場合は、基板がケース内のリブに干渉して、ぐらぐらすることがあります。  
この場合は、次の写真のように、リセットスイッチの穴とねじ穴のポストの間のリブをカットします。

![お安いプラスチックケースの加工](../assets/IMG_1631.jpeg)  


ケースと基板のネジ穴がぴったり合うように位置を調整し、ネジ止めします。  
