...
キーレイアウトは、Wide（ワイド），Narrow（ナロー），Normal（ノーマル）の、3つのバリエーションがあります。  
最下行はスペースキーとModキーの組み合わせが選択でき、左右の端はロータリーエンコーダにすることもできます。
...
すべてのレイアウトは、[Keyboard Layout Editor: Jones v.1(042)](http://www.keyboard-layout-editor.com/#/gists/53fab8cd4a4480980921f37c39e1f5f3)で確認できます。
