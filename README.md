...
- [コンセプト](#コンセプト)
- [特徴](#特徴)
  - [独自のずれ幅をもつ左右対象のアルファ部](#独自のずれ幅をもつ左右対象のアルファ部)
  - [右手のホームポジションに近づけたModキー](#右手のホームポジションに近づけたmodキー)
  - [キーレイアウトのバリエーション](#キーレイアウトのバリエーション)
- [機能](#機能)
  - [RemapやVIAなどのキーマップ書き換えツールに対応](#remapやviaなどのキーマップ書き換えツールに対応)
  - [より多くのレイヤーを使用可能](#より多くのレイヤーを使用可能)
  - [ケース](#ケース)
  - [レイヤーインジケータLED（オプション）](#レイヤーインジケータledオプション)
  - [アンダーグロー用LEDテープ（オプション）](#アンダーグロー用ledテープオプション)
  - [ロータリーエンコーダ（オプション）](#ロータリーエンコーダオプション)
  - [スピーカー（オプション）](#スピーカーオプション)
- [技術](#技術)
  - [総当たりマトリクス](#総当たりマトリクス)
- [ビルドガイド](#ビルドガイド)
- [ビルド例](#ビルド例)
...
<!--
〓
NormalのUS, JP → レイアウトのところに載せている
ZincやKatana風の、Zが外にくる完全シンメトリカルなもの。
m.teiさんのアレ。
-->
