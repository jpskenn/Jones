...
PCBとキープレートはGH60型・Poker型のケースと組み合わせて使用できます。
...
ケースを購入するよりも安いので、気軽に自作キーボードを初めてみたい方へもおすすめです。
...
2020年7月から試作段階のものを使い始め、多少の変更はあるものの、2行目と3行目にずれのないレイアウトを、メインキーボードとして使い続けています。
